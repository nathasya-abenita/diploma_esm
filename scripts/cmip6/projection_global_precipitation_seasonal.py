...
if __name__ == "__main__":
    ...
    models = [
        ("./data/cmip6/historical/pr_Amon_FIO-ESM-2-0_historical.nc",
         "data/cmip6/ssp585/pr_Amon_FIO-ESM-2-0_ssp585_r1i1p1f1_gn_20510116-20801216.nc",
         "FIO-ESM-2-0"),

        ("./data/cmip6/historical/pr_Amon_ACCESS-CM2_historical.nc",
         "data/cmip6/ssp585/pr_Amon_ACCESS-CM2_ssp585_r1i1p1f1_gn_20510116-20801216.nc",
         "ACCESS-CM2")
    ]
