...
def compare (path_hist, path_proj, varname, model_name):
    ...
    # Save
    plt.savefig(f'output/cmip6/projection_pr_{model_name}.png', dpi=300)
    plt.close()
    plt.close()

if __name__ == '__main__':
    # File names
    path_hist = r'./data/cmip6/historical/pr_Amon_FIO-ESM-2-0_historical.nc'
    path_proj = r'data/cmip6/ssp585/pr_Amon_FIO-ESM-2-0_ssp585_r1i1p1f1_gn_20510116-20801216.nc'
    varname_model = 'pr'
    ...
    compare (path_hist, path_proj, varname_model, model_name)
     ...
     # File names
    path_hist = r'./data/cmip6/historical/pr_Amon_ACCESS-CM2_historical.nc'
    path_proj = r'data/cmip6/ssp585/pr_Amon_ACCESS-CM2_ssp585_r1i1p1f1_gn_20510116-20801216.nc'
    varname_model = 'pr'
