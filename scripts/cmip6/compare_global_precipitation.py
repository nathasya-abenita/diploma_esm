...
def compare_precipitation (path_model, varname_model, path_obs, varname_obs, model_name):
    ...
    cf = xr.plot.contourf(bias, ax=ax, x='lon', y='lat', transform=ccrs.PlateCarree(),
                        ...
                        cmap='coolwarm', levels=np.linspace(-10, 10, 11))
    ...
    cf = xr.plot.contourf(bias, ax=ax, x='lon', y='lat', transform=ccrs.PlateCarree(),
                        ...
                        cmap='coolwarm', levels=np.linspace(-1, 1, 11))
...
if __name__ == '__main__':
    # File names
    path_model = r'./data/cmip6/pr_Amon_FIO-ESM-2-0_historical_regrid.nc'
    varname_model = 'pr'
    path_obs = r'data/cmip6/era5/data_stream-moda_stepType-avgad.nc'
    varname_obs = 'tp'
    ...
    # File names
    path_model = r'./data/cmip6/pr_Amon_ACCESS-CM2_historical_regrid.nc'
    varname_model = 'pr'
    path_obs = r'data/cmip6/era5/data_stream-moda_stepType-avgad.nc'
    varname_obs = 'tp'
