...
def compare (path_hist, path_proj, varname, model_name):
    ...
    # Organize
    var_hist = ds_hist[varname] * 86400
    var_proj = ds_proj[varname] * 86400
    ...
    # Save
    plt.savefig(f'output/cmip6/projection_evspsbl_{model_name}.png', dpi=300)
    plt.close()
    plt.close()

if __name__ == '__main__':
    # File names
    path_hist = r'./data/cmip6/historical/evspsbl_Amon_FIO-ESM-2-0_historical.nc'
    path_proj = r'data/cmip6/ssp585/evspsbl_Amon_FIO-ESM-2-0_ssp585_r1i1p1f1_gn_20510116-20801216.nc'
    ...
    compare (path_hist, path_proj, varname_model, model_name)
     ...
     # File names
    path_hist = r'./data/cmip6/historical/evspsbl_Amon_ACCESS-CM2_historical.nc'
    path_proj = r'data/cmip6/ssp585/evspsbl_Amon_ACCESS-CM2_ssp585_r1i1p1f1_gn_20510116-20801216.nc'
    varname_model = 'evspsbl'
